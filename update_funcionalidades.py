...
new_section = """            <!-- Comparação de Planos Premium -->
    <style>
        .pricing-section {
    ...
    <section id="comparacao" class="pricing-section w-full py-20 px-4 relative mt-24 mb-16 max-w-6xl mx-auto scroll-mt-32">
        <div class="container mx-auto">
            
            <!-- Header Pricing -->
            <div class="flex flex-col items-center text-center gap-4 mb-20">
                <h2 class="text-4xl md:text-5xl font-bold text-[#1a1a1a] tracking-tight max-w-3xl">
                    Comparação de Planos
                </h2>
                <p class="text-xl text-zinc-500 max-w-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto mb-16 relative z-10">
                ...
                <!-- Essencial -->
                <div class="pricing-card p-8 flex flex-col justify-between">
                    <div>
                ...
                <!-- Pro -->
                <div class="pricing-card pro-card p-8 flex flex-col justify-between" style="transition-delay: 100ms;">
                ...
                <!-- Elite -->
                <div class="pricing-card p-8 flex flex-col justify-between" style="transition-delay: 200ms;">
                    <div>
            ...
            <div class="max-w-3xl mx-auto bg-[#fafafa] rounded-2xl border border-zinc-200 p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 mb-24 shadow-sm">
                <div>
            ...
            <div class="w-full max-w-5xl mx-auto" id="pricing-table-wrapper">
...
pattern = re.compile(r'            <!-- Comparação de Planos -->\s*<section id="comparacao".*?</section>', re.DOTALL)
