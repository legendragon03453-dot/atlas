...
for card in lucid_cards:
    cards_html += f"""
            <!-- Card -->
            <div class="card-3d-reveal rounded-3xl overflow-hidden shadow-xl flex flex-col md:flex-row transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                <!-- Left -->
                <div class="md:w-1/3 p-6 md:p-8 bg-[#2a5585] flex items-center justify-center md:justify-start border-b md:border-b-0 md:border-r border-white/5 gap-3">
...
new_section_5 = f"""<section id="section-5" class="w-full bg-[#367CF5] min-h-[200vh] px-4 relative flex flex-col items-center">
        ...
        <div class="w-full max-w-5xl mx-auto flex flex-col gap-12 md:gap-24 relative z-10 mt-[-70vh] pb-[30vh]">
{cards_html}
        </div>
    </section>"""
